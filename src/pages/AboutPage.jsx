...
export default function AboutPage() {
  return (
    <div id = "about">
      ...
      <div id = "biography">
        <p>I've spent more than 30 years as a typesetter and book designer, but I've seen the writing on the wall. It's pretty apparent that AI is going to put me out of business before I'm ready to retire. "Time to retool," I&nbsp;thought to myself, but to do what?</p>
...
//Need useState and use... to make page name glow in the nav bar when that page is loaded